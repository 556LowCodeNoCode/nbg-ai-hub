---
type: skill
title: uat-panel — User Acceptance Testing system
audience: both
topics: [testing, qa, uat]
internal: true
authored: "2026-05-19"
...
Use it: after a feature is built and before you accept the work. Pairs naturally with `/team` (which builds) or any GSD-completed phase.
